...
public class ConsoleEx {
	...
	public static void consoleOutput() {
		...
		// 파일을 다뤄야 하는데 C:\mydir\myfile.txt
		String dir = "C:\\mydir\\myfile.txt";
		// // -> / : 역슬래시
		System.out.println(dir);
	}
	// 콘솔  입력(System.in)
	// Scanner 클래스를 이용하면 다양한 입력소스로부터 데이터를 입력 받을 수 있다
	public static void consoleInput() {
		// Tip 1. Ctrl + Shift + O -> 자동 import
		// Tip 2. Cril + Space -> Code Assist 
		Scanner scanner = new Scanner(System.in); //객체 만들어서 메모리에 적재, 표준입력으로 부터 scanner를 사용
		// 이름은? -> 문자열 데이터 입력, 나이는? -> 정수데이터 입력
		// 출력 -> 이름, 나이는 O세
