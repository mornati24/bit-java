...
public class ArrayEx {
	...
	public static void arrayMemoryTest() {
		...
		System.out.println("scores와 scores2는 같은 객체?" + (scores == scores2)); //주소 비교
	...
	public static void arrayNDim() {
		...
		System.out.println("table.length : " + table.length); //table의 길이는 3
		...
		for (int row = 0; row < table.length; row++) {
			...
			System.out.printf("%d행의 핪산 : %d%n", row, subtotal);
			sum += subtotal;
		}
